package com.horrarndoo.zyw.quickindexbar.view;
...
import com.horrarndoo.zyw.quickindexbar.R;
...
public class QuickIndexBarAdapter extends BaseAdapter {
    ...
    public QuickIndexBarAdapter(Context context, ArrayList<Person> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.adapter_quick_bar, null);
        }
